...
export default function Page() {
  return (
    <div className='pt-8 pl-12'>
      <h1 className='bg-gray-400 mb-2 border-gray-300 border-2 text-gray-800 inline-block py-3 px-10 rounded-xl font-bold text-3xl'>Modal</h1>
      <p className='text-sm mb-5 text-gray-500'>modal component docs</p>
